...
Two things
1.	This overwrites whatever is in the ‘Rprofile.site’ file, so if you have anything important in there you may want to just open that as an admin and add this line to it….  Sys.setenv(TZ='America/Halifax')… I haven’t tested but believe that should work.
